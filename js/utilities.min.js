...
class ActiveMenu {
    ...
    addActive(navbarParam) {
        location.pathname[location.pathname.length - 1] == "/" ? navbarParam[0].classList.add(this.activeClass) : navbarParam.forEach(e => {
            ...
            if (this.path.includes("".concat(this.blogPath.split(".")[0], "-page")) && e.children[0].attributes[0].value === this.blogPath) e.classList.add(this.activeClass)
        })
    }
...
class Blog {
    ...
    createCategoryWidget(data) {
        if (document.querySelector(".widget-categories") !== null) {
            ...
            categoryFilter.forEach(eachData => {
                this.categoryWrap.innerHTML += "<li><a href=\"".concat(this.sanitizePath, "-find.html?category=").concat(eachData.category.toLowerCase(), "\">").concat(eachData.category, "<span class=\"uk-label uk-label-success uk-border-pill uk-float-right\">").concat(eachData.totalPost, "</span></a></li>")
            })
        }
    }
    ...
    createTagWidget(data) {
        if (document.querySelector(".widget-tag") !== null) {
            ...
            tagFilter.forEach(eachTag => {
                if (eachTag.length !== 0) {
                    this.tagWrap.innerHTML += "<a href=\"".concat(this.sanitizePath, "-find.html?tag=").concat(eachTag, "\"><span class=\"uk-label uk-border-pill\">#").concat(eachTag, "</span></a>")
                } else {
    ...
    createPagination(data) {
        if (document.querySelector("[data-title=\"blog\"]")) {
            ...
            const page = !this.currentPage.includes("".concat(this.sanitizePath, "-page")) ? 1 : parseInt(this.currentPage.split(".")[0].split("-").pop());
            let liTag = "";
            let active = "";
    ...
    searchForm(data) {
        if (document.forms["blog-search"] !== undefined) {
            ...
            inputSearch.addEventListener("submit", e => {
                ...
                location.href = "".concat(this.sanitizePath, "-find.html?").concat(params.toString())
            });
    ...
    postFormat(_ref) {
        ...
        return "<article class=\"uk-grid-small\" data-uk-grid>\n    <div class=\"uk-width-1-5@s\">\n        <span class=\"uk-label uk-border-pill\">".concat(category, "</span>\n        <p class=\"uk-text-small uk-text-muted uk-margin-small-top uk-margin-small-bottom\">By ").concat(author.name, "</p>\n        <p class=\"uk-text-small uk-text-muted uk-margin-small-top\">").concat(date, "</p>\n    </div>\n    <div class=\"uk-width-expand\">\n        <h2><a href=\"").concat(this.sanitizePath, "/").concat(link, "\" class=\"uk-text-secondary uk-text-decoration-none\">").concat(title, "</a></h2>\n        <p>").concat(content, "</p>\n        <a href=\"").concat(this.sanitizePath, "/").concat(link, "\" class=\"uk-button uk-button-text\">Continue reading<i class=\"fas fa-chevron-right fa-xs uk-margin-small-left\"></i></a>\n    </div>\n</article>")
    }
    checkDiff(a) {
    ...
    createBreadcrumbBlog(pathParam, blogPath) {
        if (document.querySelector("[data-title=\"blog-single\"]") || document.querySelector("[data-title=\"blog-find\"]")) {
            ...
            if (document.querySelector(".".concat(articleEl)) !== null) {
                let articleTitle = document.querySelector(".".concat(articleEl)).querySelector(this.titleElement).textContent;
...
class LogoInverse {
    ...
    extractAttribute() {
        ...
        attrValue.forEach(attr => {
            ...
            Object.assign(dataAttr, {
                [sanitize.match(/(.*):/)[1].replace(/[-_\s.]+(.)?/g, (_, c) => c ? c.toUpperCase() : "")]: sanitize.match(/: (.*)/)[1]
            })
        });
    ...
    logoInject() {
        const logoPath = document.querySelector("img").getAttribute("src").split("/");
        ...
        imgElement.setAttribute("src", logoPath.join("/"));
...
class Timeline {
    ...
    init() {
        if (document.querySelector(".".concat(this.elementName)) !== null) {
            const timelineArray = Array.from(document.querySelector(".".concat(this.elementName)).children);
